...
{
	public static final ResourceLocation[] TEXTURES = new ResourceLocation[] { new ResourceLocation(Overwatch.MODID, "entity/particle/spark_0"), new ResourceLocation(Overwatch.MODID, "entity/particle/spark_1"), new ResourceLocation(Overwatch.MODID, "entity/particle/spark_2"), new ResourceLocation(Overwatch.MODID, "entity/particle/spark_3") };
	...
	public ParticleSpark(World world, double x, double y, double z, int color, int colorFade, float scale, int maxAge)
	{
		...
		ResourceLocation texture = new ResourceLocation(Overwatch.MODID, "entity/particle/spark_" + world.rand.nextInt(4));
