...
import com.tingkai.overwatch.potions.PotionFrozen;
		...
		public IMessage onMessage(final SPacketPotionEffect packet, final MessageContext ctx)
		{
			...
			mainThread.addScheduledTask(new Runnable()
			{
				...
				public void run()
				{
					...
					{
						((EntityLivingBase) entity).addPotionEffect(new PotionEffect(potion, packet.duration, packet.amplifier, packet.ambient, packet.showParticles));
					}
