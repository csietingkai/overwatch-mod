...
public class ItemBastionGun extends ItemModWeapon
{
	public ItemBastionGun()
	{
		super(40);
		/*
		 * this.addPropertyOverride(new ResourceLocation("pull"), new
		 * IItemPropertyGetter() {
		 * @SideOnly(Side.CLIENT) public float apply(ItemStack stack, @Nullable
		 * World worldIn, @Nullable EntityLivingBase entityIn) { return entityIn
		 * == null ? 0.0F : (!(entityIn.getActiveItemStack().getItem()
		 * instanceof ItemHanzoBow) ? 0.0F :
