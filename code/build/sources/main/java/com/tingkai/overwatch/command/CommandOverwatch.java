...
public class CommandOverwatch implements ICommand
{
	...
	@SuppressWarnings("serial") // prevent waning
	@Override
		...
		if (sender instanceof EntityPlayer && args.length == 1)
		{
			...
			if (hero != null)
			{
				...
				for (EntityEquipmentSlot slot : EntityEquipmentSlot.values())
				{
					...
					{
						player.setItemStackToSlot(slot, hero.getEquipment(slot) == null ? ItemStack.EMPTY : new ItemStack(hero.getEquipment(slot)));
					}
