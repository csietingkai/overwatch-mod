...
{
	public static final ResourceLocation[] TEXTURES = new ResourceLocation[] { new ResourceLocation(Overwatch.MODID, "entity/particle/smoke_0"), new ResourceLocation(Overwatch.MODID, "entity/particle/smoke_1"), new ResourceLocation(Overwatch.MODID, "entity/particle/smoke_2"), new ResourceLocation(Overwatch.MODID, "entity/particle/smoke_3") };
	...
	public ParticleSmoke(World world, double x, double y, double z, int color, int colorFade, float scale, int maxAge)
	{
		...
		ResourceLocation texture = new ResourceLocation(Overwatch.MODID, "entity/particle/smoke_0");
	...
	public void onUpdate()
	{
		...
		if (this.particleAge % (this.particleMaxAge / 4) == 0)
		{
			...
			ResourceLocation texture = new ResourceLocation(Overwatch.MODID, "entity/particle/smoke_" + num);
			TextureAtlasSprite sprite = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(texture.toString());
			this.setParticleTexture(sprite);
		}
	}
